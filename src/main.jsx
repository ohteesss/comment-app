...
const comment = comments.find((commment) =>
  commment.replies.some((reply) => reply.id === 4)
);

const replies = comment.replies;

const reply = comments
  .find((commment) => commment.replies.some((reply) => reply.id === 4))
  .replies.filter((el) => el.id !== 4);

comment.replies = reply;
console.log(reply);

const val = comments.find((comment) =>
  comment.replies.includes((reply) => reply.id === 4)
);
